    ...
    <div className="Services">
        ...
        <div className='Cards'>
            <div className="Card">
                ...
                <div className="Right">
                    <p className="Title">Pet Adoption <Image src="/pas.svg" width={25} height={25} alt='pasicon'/></p>
            ...
            <div className="Card">
                ...
                <div className="Left">
                    <p className="Title">Pet SOS <Image src="/sosicon.svg" width={36} height={36} alt='pasicon'/></p>
